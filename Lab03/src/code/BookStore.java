...
/**
 * Models a books store with books stored on its data base
 * @author Minh & Pedro
 * @version 1.0
 */
class BookStore
{
    ...
    {
        // Check if the provided name is amazon. Assign it to Chapters in that case
        if (bookStoreName.toLowerCase() == "Amazon".toLowerCase())
        {
            this.bookStoreName = "Chapter";
        }
        else
        {
        ...
        novels.add(new Novel("Are You There God? Ti's Me, Margaret.", "Judy Blume", 1970));
